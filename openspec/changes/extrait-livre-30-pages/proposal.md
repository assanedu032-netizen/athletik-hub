...
On ouvre donc une vitrine : les 30 premières pages, lisibles dans l'app, avec
l'achat au bout. Et Titan gagne le droit d'y renvoyer — **avec parcimonie**.

## What Changes

- **Nouvel écran « Extrait du livre »** : les 30 premières pages, lues dans
  l'app, avec la pagination, le zoom et la reprise à la page où l'on s'était
  arrêté.
- **Un appel à l'achat en fin d'extrait**, à la 30ᵉ page, réutilisant
...
- **Ces deux propositions sont plafonnées** : une par jour au maximum, jamais
  ...
  livre.
- **NON-OBJECTIF** : servir le livre entier. Seul un fichier limité aux 30
  premières pages sera déposé ; le livre complet n'entre pas dans le dépôt.

## Capabilities

### New Capabilities
- `extrait-livre`: l'écran de lecture des 30 premières pages, sa progression,
...
**Nouveaux fichiers**
- `book/extrait-30p.pdf` — le seul fichier du livre présent dans le dépôt.
