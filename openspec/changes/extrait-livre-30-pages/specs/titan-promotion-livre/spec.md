...
Une question hors sujet — nutrition, matériel, problème technique de
l'application — SHALL NOT déclencher de carte.
...
- **WHEN** l'athlète a atteint la page 30
- **AND** les plafonds de fréquence le permettent
...
- **WHEN** l'athlète s'est arrêté à la page 8
